...
| `module_manifest.yaml` | Machine registry for dense module books, module routers, and module-level law/current-fact/test links; P1 lands `state`, `engine`, and `data` first |
