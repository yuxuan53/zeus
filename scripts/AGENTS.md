...
Disposition: NEW
Authority basis: architecture/zones.yaml; architecture/negative_constraints.yaml; docs/governance/zeus_autonomous_delivery_constitution.md; current repo scripts.
