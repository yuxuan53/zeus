...
| P0-D | P0 | Close runtime spine: pending/live fail-closed, Day0 terminal phase, durable transition/event emission | runtime lane | IN_PROGRESS | Slices 1-3 are landed: phantom-void, stale-Day0 freshness, and pending/live verification owner contraction are closed. Remaining P0-D work is Day0 exit authority, durable `day0_window` lifecycle emission, and deeper fill/chain accounting convergence. |
