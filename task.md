...
| P1-E | P1 | Migrate learning loop to authoritative ledger + evaluated opportunity set | truth/learning lane | IN_PROGRESS | Slice 1 is landed: authoritative settlement readers are now env-filtered. Remaining work is deeper learning/consumer migration on top of those cleaner readers. |
