...
| P2-H | P1 | Forecast-layer Phase-1 de-hardcode: Day0 backbone, lead-continuous mean/sigma, heteroscedastic sigma | forecast lane | READY | P0/P1 runtime/learning/truth closure for the current base is complete; this is now the next active lane. |
