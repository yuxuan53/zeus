...
| `operations/task_2026-04-25_p2_daily_observation_revision_history/` | Active POST_AUDIT 4.4.A2 daily observation backfill revision-history packet; route through `operations/current_state.md` |
