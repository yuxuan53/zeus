...
| `operations/task_2026-04-25_p2_obs_v2_revision_history/` | Active POST_AUDIT 4.4.A1 obs_v2 revision-history packet; route through `operations/current_state.md` |
