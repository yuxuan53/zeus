...
- Active packet: `P5.3D-PORTFOLIO-TERMINAL-LIFECYCLE-HOTSPOT`
...
1. Run the post-close third-party critic and verifier gate on accepted `P5.3D-PORTFOLIO-TERMINAL-LIFECYCLE-HOTSPOT`.
...
5. `work_packets/P5.3D-PORTFOLIO-TERMINAL-LIFECYCLE-HOTSPOT.md`
