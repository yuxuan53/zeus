...
1. Run the post-close critic + verifier gate for accepted `P7R4-OPEN-POSITION-CANONICAL-BACKFILL`.
2. Do not freeze any later P7 packet unless the post-close gate passes and parity-backed cutover readiness is still honest.
