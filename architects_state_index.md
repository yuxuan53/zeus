...
- Active packet: `P5.3E-ENTRY-LIFECYCLE-HOTSPOTS`
...
1. Run the post-close third-party critic and verifier gate on accepted `P5.3E-ENTRY-LIFECYCLE-HOTSPOTS`.
...
5. `work_packets/P5.3E-ENTRY-LIFECYCLE-HOTSPOTS.md`
