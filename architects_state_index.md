...
1. Execute `P5.4-QUARANTINE-SEMANTICS-HARDENING` inside its frozen boundary.
2. Preserve the pre-close and post-close critic/verifier gates before any closeout claim.
