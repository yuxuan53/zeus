...
- [ ] `strategy_health` refresh/query substrate installed from lawful inputs
- [ ] explicit present-path and absent/stale-path semantics tested
- [ ] targeted strategy-health tests green
- [ ] pre-close critic review passed
- [ ] pre-close verifier review passed
- [ ] P6.0 accepted and pushed
- [ ] post-close third-party critic review passed
- [ ] post-close third-party verifier review passed

## Next required action

1. Implement `P6.0-STATUS-SUMMARY-INPUT-READINESS`.
