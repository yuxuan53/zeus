...
- [ ] implement reconciliation chain-event builders in `src/engine/lifecycle_events.py`
...
1. Add the pure reconciliation chain-event builder layer.
2. Keep caller migration for a later packet.
